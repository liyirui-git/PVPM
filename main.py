...
def build_engine(args, datamanager, model, optimizer, scheduler):
    if args.app == 'image':
        if args.loss == 'softmax':
            if args.load_pose:
                if args.graph_matching:
                    engine = torchreid.engine.PoseSoftmaxEngine_wscorereg(
                    # engine = torchreid.engine.PoseSoftmaxEngine(
                        datamanager,
                        model,
                        optimizer,
                        scheduler=scheduler,
                        ...
                        reg_matching_score_epoch = args.reg_matching_score_epoch,
